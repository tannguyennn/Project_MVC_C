...
{
    public class KhachHangs63132204Controller : Controller
    {
        private Project_63132204Entities db = new Project_63132204Entities();

        // GET: KhachHangs63132204
        public ActionResult Index()
        {
            return View(db.KhachHangs.ToList());
        }

        // GET: KhachHangs63132204/Details/5
        ...
        // GET: KhachHangs63132204/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: KhachHangs63132204/Create
        ...
        // POST: KhachHangs63132204/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: KhachHangs63132204/Delete/5
        ...
        // POST: KhachHangs63132204/Delete/5
